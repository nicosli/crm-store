...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_apexcharts__ = __webpack_require__(10);
...
Vue.component('lista-proveedores', __webpack_require__(14));

Vue.component('lista-productos', __webpack_require__(17));

Vue.component('lista-piezas', __webpack_require__(50));

Vue.component('modulo-punto-venta', __webpack_require__(23));
...
Component.options.__file = "resources/assets/js/components/ListaProductos.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57738e72", Component.options)
  } else {
    hotAPI.reload("data-v-57738e72", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteClick: function deleteClick(row) {
            ...
            var message = 'Estás seguro de eliminar el producto ' + '<b>' + row.nombre + '?</b>, se eliminará todos' + ' los productos registrados con este proveedor';
            this.$dialog.confirm({
        ...
        deleteRow: function deleteRow(row) {
            ...
            this.loadingModal = true;
            this.$http.delete('http://local.store.nicosli.com/api/productos?id=' + row.id).then(function (_ref) {
                var data = _ref.data;
        ...
        onSubmitControll: function onSubmitControll() {
            if (this.addProducto.id == '') this.onSubmit();else this.onSubmitUpdate();
        },
        onSubmitUpdate: function onSubmitUpdate() {
            var _this3 = this;

            this.loadingModal = true;
            this.$http.put('http://local.store.nicosli.com/api/productos', this.addProducto, { emulateJSON: true }).then(function (_ref2) {
                var data = _ref2.data;
                ...
                if (data.error == false) {
                    _this3.loadTabla();
                    _this3.modalForm = false;
                    _this3.searchKeyword = _this3.addProducto.nombre;
                    _this3.$toast.open({
        ...
        onSubmit: function onSubmit() {
            ...
            this.loadingModal = true;
            this.$http.post('http://local.store.nicosli.com/api/productos', this.addProducto, { emulateJSON: true }).then(function (_ref3) {
                var data = _ref3.data;
                ...
                if (data.error == false) {
                    _this4.loadTabla();
                    _this4.modalForm = false;
                    _this4.searchKeyword = _this4.addProducto.nombre;
                    _this4.$toast.open({
        ...
        loadTabla: function loadTabla() {
            ...
            this.loading = true;
            this.$http.get('http://local.store.nicosli.com/api/productos').then(function (_ref4) {
                var data = _ref4.data;
                ...
                _this5.categorias = data.categorias;
                _this5.colores = data.colores;
                _this5.proveedores = data.proveedores;
                _this5.tallas = data.tallas;
            }).catch(function (error) {
                _this5.loading = false;
                throw error;
            });
                    ...
                    return [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                        " +
                              _vm._s(
                                _vm._f("truncate")(props.row.descripcion, 15)
                              ) +
                              "\n                    "
                          )
                        ]
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                        " +
                              _vm._s(_vm._f("formatNumber")(props.row.costo)) +
                              "\n                    "
                          )
                        ]
                      ),
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                        " +
                              _vm._s(
                                _vm._f("formatNumber")(props.row.precio_publico)
                              ) +
                              "\n                    "
                          )
                        ]
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "a",
                            {
                              attrs: { href: "/lista/piezas/" + props.row.id }
                            },
                            [_vm._v("Piezas")]
                          )
                        ]
                      ...
                      _c(
                        ...
                        [
                          _c("b-input", {
                            ...
                            model: {
                              value: _vm.addProducto.nombre,
                              callback: function($$v) {
                                _vm.$set(_vm.addProducto, "nombre", $$v)
                              },
                              expression: "addProducto.nombre"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          _c("b-input", {
                            ...
                            model: {
                              value: _vm.addProducto.costo,
                              callback: function($$v) {
                                _vm.$set(_vm.addProducto, "costo", $$v)
                              },
                              expression: "addProducto.costo"
                            }
                          })
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          _c("b-input", {
                            ...
                            model: {
                              value: _vm.addProducto.precio_publico,
                              callback: function($$v) {
                                _vm.$set(_vm.addProducto, "precio_publico", $$v)
                              },
                              expression: "addProducto.precio_publico"
                            }
                          })
                        ],
                        1
                              ...
                              [
                                _c(
                                  "b-select",
                                  {
                                    ...
                                    model: {
                                      value: _vm.addProducto.categoria_id,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.addProducto,
                                          "categoria_id",
                                      ...
                                      expression: "addProducto.categoria_id"
                                    }
                                  },
                              ...
                              [
                                _c(
                                  "b-select",
                                  {
                                    ...
                                    model: {
                                      value: _vm.addProducto.proveedor_id,
                                      callback: function($$v) {
                                        _vm.$set(
                                          _vm.addProducto,
                                          "proveedor_id",
                                      ...
                                      expression: "addProducto.proveedor_id"
                                    }
                                  },
                      ...
                      _c(
                        ...
                        [
                          _c("b-input", {
                            ...
                            model: {
                              value: _vm.addProducto.descripcion,
                              callback: function($$v) {
                                _vm.$set(_vm.addProducto, "descripcion", $$v)
                              },
                              expression: "addProducto.descripcion"
                            }
                          })
                        ],
                        1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-57738e72", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/PuntoVenta.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9dcfca42", Component.options)
  } else {
    hotAPI.reload("data-v-9dcfca42", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        calculaTotales: function calculaTotales() {
            ...
            this.carrito.forEach(function (item) {
                _this.granTotal += parseInt(item.producto.precio_publico);
            });
        },
        searchProduct: function searchProduct() {
            ...
            this.loading = true;
            this.$http.get('http://local.store.nicosli.com/api/piezas/' + this.barcode).then(function (_ref) {
                var data = _ref.data;

                _this2.loading = false;
                if (data.error == false) {
                    _this2.carrito.push(data.result);
                    _this2.barcode = '';
                    _this2.calculaTotales();
                } else {
                    _this2.$toast.open({
    ...
    computed: {
        filteredData: function filteredData() {
            ...
            return this.data.filter(function (item) {
                _this3.filtered = item.nombre.toLowerCase().includes(_this3.searchKeyword.toLowerCase());

                return _this3.filtered;
            });
        }
    },
    filters: {
      ...
      _c("div", { staticClass: "card-content" }, [
        ...
        _vm.carrito.length > 0
          ? _c(
              ...
              {
                staticClass:
                  "m-t-md table is-responsive is-striped is-hoverable is-fullwidth"
              },
              [
                _vm._m(1),
                _vm._v(" "),
                _c(
                  "tbody",
                  _vm._l(_vm.carrito, function(item) {
                    return _c("tr", [
                      _c("td", [
                      ...
                      _c("td", [
                        _vm._v(
                          "\n                            " +
                            _vm._s(item.producto.precio_publico) +
                            "\n                        "
                        )
                      ]),
                      _vm._v(" "),
        ...
        _vm.carrito.length > 0
          ? _c(
              ...
              [
                  ...
                  _c(
                    ...
                    [
                      _c("b", [
                        _vm._v(
                          "$ MXN " +
                            _vm._s(_vm._f("formatNumber")(_vm.granTotal))
                        )
                      ])
                    ]
                  )
                ...
                _vm._v(" "),
                _c("div", { staticClass: "is-clearfix m-b-sm" }),
                _vm._v(" "),
                _c(
                  "b-button",
                  {
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.carrito.length > 0,
                        expression: "carrito.length > 0"
                      }
                    ],
                    staticClass: "is-pulled-right",
                    attrs: { type: "is-info" },
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("td", [_c("a", { staticClass: "delete is-danger" })])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9dcfca42", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/ListaPiezas.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-29a5049c", Component.options)
  } else {
    hotAPI.reload("data-v-29a5049c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        deleteClick: function deleteClick(row) {
            ...
            var message = 'Estás seguro de eliminar la pieza? ' + '<b>' + row.barcode + '?</b>';
            this.$dialog.confirm({
        ...
        deleteRow: function deleteRow(row) {
            ...
            this.loadingModal = true;
            this.$http.delete('http://local.store.nicosli.com/api/piezas?id=' + row.id).then(function (_ref) {
                var data = _ref.data;
        ...
        onSubmitControll: function onSubmitControll() {
            if (this.addPieza.id == '') this.onSubmit();else this.onSubmitUpdate();
        },
        onSubmitUpdate: function onSubmitUpdate() {
            var _this3 = this;

            this.loadingModal = true;
            this.$http.put('http://local.store.nicosli.com/api/piezas', this.addPieza, { emulateJSON: true }).then(function (_ref2) {
                var data = _ref2.data;
                ...
                if (data.error == false) {
                    _this3.loadTabla();
                    _this3.modalForm = false;
                    _this3.searchKeyword = _this3.addPieza.barcode;
                    _this3.$toast.open({
        ...
        onSubmit: function onSubmit() {
            ...
            this.$http.post('http://local.store.nicosli.com/api/piezas', this.addPieza, { emulateJSON: true }).then(function (_ref3) {
                var data = _ref3.data;
                ...
                if (data.error == false) {
                    _this4.loadTabla();
                    _this4.modalForm = false;
                    _this4.searchKeyword = _this4.addPieza.barcode;
                    _this4.$toast.open({
                        message: 'El Producto se insertó correctamente',
                        type: 'is-success'
                    });
        ...
        loadTabla: function loadTabla() {
            ...
            this.loading = true;
            this.$http.get('http://local.store.nicosli.com/api/piezas?producto_id=' + this.producto_id).then(function (_ref4) {
                var data = _ref4.data;
    ...
    computed: {
        filteredData: function filteredData() {
            ...
            return this.data.filter(function (item) {
                _this6.filtered = item.barcode.toLowerCase().includes(_this6.searchKeyword.toLowerCase());
                    ...
                    return [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                        " +
                              _vm._s(props.row.producto.proveedor.nombre) +
                              "\n                    "
                          )
                        ]
                      ),
                      ...
                      _c(
                        ...
                        [
                          _c("label", { staticClass: "has-text-info" }, [
                            _vm._v(
                              "\n                            " +
                                _vm._s(props.row.existencia) +
                                "\n                        "
                              ...
                              [
                                _c(
                                  "b-select",
                                  {
                                    ...
                                    model: {
                                      value: _vm.addPieza.talla_id,
                                      callback: function($$v) {
                                        _vm.$set(_vm.addPieza, "talla_id", $$v)
                                      },
                                      expression: "addPieza.talla_id"
                                    }
                                  },
                                  _vm._l(_vm.tallas, function(talla) {
                                    return _c(
                                      "option",
                                      {
                                        key: talla.id,
                                        domProps: { value: talla.id }
                                      },
                                      [
                                        _vm._v(
                                          "\n                                    " +
                              ...
                              [
                                _c(
                                  "b-select",
                                  {
                                    ...
                                    model: {
                                      value: _vm.addPieza.color_id,
                                      callback: function($$v) {
                                        _vm.$set(_vm.addPieza, "color_id", $$v)
                                      },
                                      expression: "addPieza.color_id"
                                    }
                                  },
                            ...
                            _c(
                              ...
                              [
                                _c("b-input", {
                                  ...
                                  model: {
                                    value: _vm.addPieza.existencia,
                                    callback: function($$v) {
                                      _vm.$set(_vm.addPieza, "existencia", $$v)
                                    },
                                    expression: "addPieza.existencia"
                                  }
                                })
                              ],
                              1
...
var staticRenderFns = [
    ...
    return _c(
      ...
      [
        _c("ul", [
          ...
          _vm._v(" "),
          _c("li", [
            _c("a", { attrs: { href: "/lista/productos" } }, [
              _vm._v("Almacén")
            ])
          ]),
          _vm._v(" "),
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "column is-9-widescreen" }, [
      _c("h3", { staticClass: "subtitle m-t-sm" }, [_vm._v("Lista de piezas")])
    ])
  }
]
render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-29a5049c", module.exports)
  }
}
